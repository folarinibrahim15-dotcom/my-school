...
export default function StudentQuickActions() {
    ...
    const actions = [
        ...
        },
        {
            ...
            description: "Upload pending assignments",
            icon: <FiUpload />
        },
        {
    ...
    const gridResponsive = `
        @media (min-width: 640px) {
            .student-quick-grid { grid-template-columns: repeat(2, 1fr) !important; } /* sm: 2 col */
        }
        @media (min-width: 1024px) {
            .student-quick-grid { grid-template-columns: repeat(4, 1fr) !important; } /* lg: 4 col */
        }
    `;
    ...
    return (
        <>
            ...
            <section style={section}>
                ...
                <div className="student-quick-grid" style={grid}>
