    ...
    const announcements = [
        {
            ...
            description: "Students are encouraged to prepare for the upcoming sports event.",
            date: "14 August, 2026",
            type: "School Event"
        },
        {
            title: "Mathematics Assignment Uploaded",
            description: "A new mathematics assignment has been added. Submit before the deadline.",
            date: "10 August, 2026",
            type: "Academic"
        },
        {
            title: "Examination Timetable Released",
            description: "The examination timetable is now available for students.",
            date: "05 August, 2026",
            type: "Announcement"
        }
    ];
            ...
            <section style={section}>
                ...
                <div style={list}>
                    {announcements.map((item) => (
                        ...
                        >
                            <div className="student-announce-header" style={cardHeader}>
