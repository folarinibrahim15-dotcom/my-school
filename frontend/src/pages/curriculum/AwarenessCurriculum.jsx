...
import awarenessContent from "../../data/awarenessContent";
...
export default function AwarenessCurriculum() {

  const [activeMenu, setActiveMenu] = useState("Awareness Curriculum");

  const [searchQuery, setSearchQuery] = useState("");

  const [searchNotFound, setSearchNotFound] = useState(false);

  const current = awarenessContent[activeMenu];
...
{/* ======================================
            ...
            <aside style={{ 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
                ...
                {Object.keys(awarenessContent).map((item) => (
