...
import upcomingContent from "../../data/upcomingContent";
...
export default function UpcomingEvents() {
  ...
  const [activeMenu, setActiveMenu] = useState("Upcoming Events");

  const [searchQuery, setSearchQuery] = useState("");

  const [searchNotFound, setSearchNotFound] = useState(false);

  const current = upcomingContent[activeMenu];
...
{/* ======================================
            ...
            <aside style={{ 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
                ...
                {Object.keys(upcomingContent).map((item) => (
