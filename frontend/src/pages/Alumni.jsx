...
import alumniContent from "../data/alumniContent";
...
const menuItems = [
  "Alumni",
  "Our Vision for the Alumni Community",
  "Why stay connected?",
  "Alumni Spotlight",
...
export default function Alumni() {
  ...
  const [activeMenu, setActiveMenu] = useState("Alumni");

  const [searchQuery, setSearchQuery] = useState("");

  const [searchNotFound, setSearchNotFound] = useState(false);

  const current = alumniContent[activeMenu];
 ...
 <div style={{
  ...
  <p style={{
   ...
   "True success is not measured by the certificates we earn, but by the <br/>
    character we build, the lives we impact, and the legacy we leave behind."
  </p>
...
{/* ======================================
            ...
            <aside style={{ 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
                ...
                {Object.keys(alumniContent).map((item) => (
