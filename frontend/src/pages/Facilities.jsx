...
import facilitiesContent from "../data/facilitiesContent";
...
export default function Facilities() {
  ...
  const [activeMenu, setActiveMenu] = useState("Facilities");

  const [searchQuery, setSearchQuery] = useState("");

  const [searchNotFound, setSearchNotFound] = useState(false);

  const current = facilitiesContent[activeMenu];
 ...
 <div style={{
  ...
  <p style={{
   ...
   We have the right state of the art facilities to help invigorate and<br /> 
    nurture the intellect, creativity and personality of our students.
  </p>
...
{/* ======================================
            ...
            <aside style={{ 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
                ...
                {Object.keys(facilitiesContent).map((item) => (
...
{/* ======================================
      ...
      <section style={{
        ...
        <div style={{
          ...
          >
            “We can’t solve problems by using the same kind of<br/>
